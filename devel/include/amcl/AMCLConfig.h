...
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("laser_model_type", "str", 0, "Which model to use, either beam, likelihood_field or likelihood_field_prob.", "{'enum_description': 'Laser Models', 'enum': [{'srcline': 52, 'description': 'Use beam laser model', 'srcfile': '/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg', 'cconsttype': 'const char * const', 'value': 'beam', 'ctype': 'std::string', 'type': 'str', 'name': 'beam_const'}, {'srcline': 52, 'description': 'Use likelihood_field laser model', 'srcfile': '/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg', 'cconsttype': 'const char * const', 'value': 'likelihood_field', 'ctype': 'std::string', 'type': 'str', 'name': 'likelihood_field_const'}]}", &AMCLConfig::laser_model_type)));
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("laser_model_type", "str", 0, "Which model to use, either beam, likelihood_field or likelihood_field_prob.", "{'enum_description': 'Laser Models', 'enum': [{'srcline': 52, 'description': 'Use beam laser model', 'srcfile': '/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg', 'cconsttype': 'const char * const', 'value': 'beam', 'ctype': 'std::string', 'type': 'str', 'name': 'beam_const'}, {'srcline': 52, 'description': 'Use likelihood_field laser model', 'srcfile': '/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg', 'cconsttype': 'const char * const', 'value': 'likelihood_field', 'ctype': 'std::string', 'type': 'str', 'name': 'likelihood_field_const'}]}", &AMCLConfig::laser_model_type)));
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 52 "/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_beam_const = "beam";
//#line 52 "/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_likelihood_field_const = "likelihood_field";
//#line 56 "/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_diff_const = "diff";
//#line 57 "/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_omni_const = "omni";
//#line 58 "/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_diff_corrected_const = "diff-corrected";
//#line 59 "/home/kyle/SeniorDesign/src/navigation/amcl/cfg/AMCL.cfg"
