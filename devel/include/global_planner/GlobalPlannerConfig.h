...
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(GlobalPlannerConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerConfig::ParamDescription<int>("orientation_mode", "int", 0, "How to set the orientation of each point", "{'enum_description': 'How to set the orientation of each point', 'enum': [{'srcline': 14, 'description': 'No orientations added except goal orientation', 'srcfile': '/home/kyle/SeniorDesign/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'None'}, {'srcline': 15, 'description': 'Orientations point to the next point on the path', 'srcfile': '/home/kyle/SeniorDesign/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Forward'}, {'srcline': 16, 'description': 'Orientations are a linear blend of start and goal pose', 'srcfile': '/home/kyle/SeniorDesign/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Interpolate'}, {'srcline': 18, 'description': 'Forward orientation until last straightaway, then a linear blend until the goal pose', 'srcfile': '/home/kyle/SeniorDesign/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ForwardThenInterpolate'}]}", &GlobalPlannerConfig::orientation_mode)));
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 14 "/home/kyle/SeniorDesign/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_None = 0;
//#line 15 "/home/kyle/SeniorDesign/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Forward = 1;
//#line 16 "/home/kyle/SeniorDesign/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Interpolate = 2;
//#line 18 "/home/kyle/SeniorDesign/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
