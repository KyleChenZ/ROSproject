...
if("TRUE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /home/nvidia/SeniorDesign/src/slam_gmapping/gmapping)
  set(gmapping_DEVEL_PREFIX /home/nvidia/SeniorDesign/devel)
  set(gmapping_INSTALL_PREFIX "")
  set(gmapping_PREFIX ${gmapping_DEVEL_PREFIX})
else()
  set(gmapping_SOURCE_PREFIX "")
  set(gmapping_DEVEL_PREFIX "")
  set(gmapping_INSTALL_PREFIX /home/nvidia/SeniorDesign/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/SeniorDesign/src/slam_gmapping/gmapping/${idir}'.  ${_report}")
    endif()
